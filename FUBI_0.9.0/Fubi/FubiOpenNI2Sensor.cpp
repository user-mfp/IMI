...
bool FubiOpenNI2Sensor::initWithOptions(const Fubi::SensorOptions& options)
{
	...
	updateOptions();
	// And the rest of the options (basically copied from the passed options
	m_options.m_trackingProfile = SkeletonTrackingProfile::ALL; // Currently only all supported
