...
// And linear movement recognizers
#include "GestureRecognizer/LinearMovementRecognizer.h"

// And angular movement recognizers
#include "GestureRecognizer/AngularMovementRecognizer.h"

// And linear acceleration
#include "GestureRecognizer/LinearAccelerationRecognizer.h"
...
namespace Fubi
{
		...
		bool useFilteredData /*= false*/)
	{
		return new JointRelationRecognizer(joint, relJoint, minValues, maxValues, 
			minDistance, maxDistance, useLocalPositions, minConfidence, measuringUnit, useFilteredData);
	}
	...
	IGestureRecognizer* createMovementRecognizer(Fubi::SkeletonJoint::Joint joint,
		...
		bool useOnlyCorrectDirectionComponent /*= true*/)
	{
		return new LinearAccelerationRecognizer(joint, direction, minAccel, maxAccel, minConfidence, maxAngleDiff, useOnlyCorrectDirectionComponent);
	}
	...
	IGestureRecognizer* createPostureRecognizer(Fubi::SkeletonJoint::Joint handJoint /*= RIGHT_HAND*/,
		...
		bool useFilteredData /*= false*/)
	{
		return new FingerCountRecognizer(handJoint, minFingers, maxFingers, minConfidence, useMedianCalculation, useFilteredData);
	}
