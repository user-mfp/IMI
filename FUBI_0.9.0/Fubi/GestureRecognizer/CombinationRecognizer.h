...
public:
	...
	Fubi::RecognitionResult::Result getRecognitionProgress(std::vector<FubiUser::TrackingData>* userStates, bool restart, bool returnFilteredData, Fubi::RecognitionCorrectionHint* correctionHint = 0x0);
	// Same with finger tracking data
	Fubi::RecognitionResult::Result getRecognitionProgress(std::vector<FubiHand::FingerTrackingData>* userStates, bool restart, bool returnFilteredData, Fubi::RecognitionCorrectionHint* correctionHint = 0x0);
	...
	Fubi::RecognizerTarget::Target getRecognizerTarget() const { return m_targetSensor; }
...
protected:
	...
	std::vector<FubiUser::TrackingData> m_filteredUserStates;
	// Again the alternative: FubiHand data
	std::vector<FubiHand::FingerTrackingData> m_handStates;
	std::vector<FubiHand::FingerTrackingData> m_filteredHandStates;
