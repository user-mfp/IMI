 ...
 * - FUBI_USE_OPENNI2 - define to use OpenNI version 2.x (default)
 * - FUBI_USE_KINECT_SDK - define to use the Kinect SDK
 * - FUBI_KINECT_SDK_MAX_NUM_FACES_TRACKED - define the number of users for the kinect sdk face tracking to be used
...
// Uncomment to link against a special version of OpenCV (given as a three digit number)
...
//#define FUBI_OPENCV_VERSION 247
